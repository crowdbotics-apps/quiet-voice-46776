"""
Django settings for quiet_voice_46776 project.
...
ROOT_URLCONF = 'quiet_voice_46776.urls'
...
WSGI_APPLICATION = 'quiet_voice_46776.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "quiet_voice_46776 API",
    "DESCRIPTION": "API documentation for quiet_voice_46776 App",
    "VERSION": "v1",
}
